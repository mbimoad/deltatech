<section class="twolayer">
    ...
    <div class="twolayer-img">
        <img src="company/image/commitmen.jpg" class="float-img img-left">
...
<section class="banner-info">
    ...
    <div class="information">
        <h1>Leader in Sustainable Investments & EPC for Better Quality of Life</h1>
        <h3>Vision - 2030</h3>
    </div>
</section>
...
<section class="twolayer reverse">
    ...
    <div class="twolayer-img">
        <img src="company/image/commitmen.jpg" class="float-img img-right">
        <img src="company/image/whoimg.jpg">
    </div>
</section>